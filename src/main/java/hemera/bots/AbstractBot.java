...
public abstract class AbstractBot {
    ...
    static {
        ...
        decoders.put(SignedTrasferTransaction.TEMPLATE_ID, SignedTrasferTransaction.Contract::fromIdAndRecord);
        decoders.put(UnsignedTrasferTransaction.TEMPLATE_ID, UnsignedTrasferTransaction.Contract::fromIdAndRecord);
